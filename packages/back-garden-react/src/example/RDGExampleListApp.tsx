...
import '../incubator/react-data-grid/rdg-bootstrap-3.3.7-custom.css';
import '../incubator/react-data-grid/rdg-main.css';
import * as examples from './grid/index';
...
export class RDGExampleListApp extends React.Component {
  ...
  render() {
    ...
    const CurExampleApp: React.ComponentType = curName ? examples[curName] : () => <h4>未选择示例</h4>;
    return (
      <div>
        <div>
        ...
        <h2>{curName}</h2>
        <div style={{ float: 'left', backgroundColor: 'snow', padding: '10px' }} className='left-toc-placeholder'>
        ...
        <div style={{ float: 'left', margin: '10px', width: 720 }} className='right-comp-placeholder'>
          <CurExampleApp />
        </div>
      </div>
    );
